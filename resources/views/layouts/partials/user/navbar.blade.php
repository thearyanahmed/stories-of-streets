                ...
                <div class="ml-3 relative">
                    @if(auth()->check())
                        ...
                        <div @click.away="showDropdown = false"
                             ...
                             class="z-10 origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
                            <a href="{{ profileEditURL() }}" class="block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100" role="menuitem">Your Profile</a>
                            <a href="{{ settingsURL() }}" class="block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100" role="menuitem">Settings</a>
                    ...
                    @else
                         ...
                         <div x-show="showAuthDropdown" @click.away="showAuthDropdown = false" class="z-10 origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
